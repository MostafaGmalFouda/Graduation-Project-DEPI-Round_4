...
def pipeline_stream():
    ...
    # ✅ نحفظ filepath هنا قبل ما يبدأ الـ generator
    # عشان الـ generator بيشتغل برا الـ request context
    saved_filepath = filepath
    saved_reports_folder = REPORTS_FOLDER
    ...
    def generate():
        try:
            pipeline = EDAPipeline(saved_filepath)
            ...
            output_path = os.path.join(saved_reports_folder, out_file)
